 ...
 * from mongodb (corrent CG problem)
 */
public class JSON {
...
class JSONParser {
    ...
    protected void doCallback(final String name, final Object value) {
        ...
        if (value == null) {
            _callback.gotNull(tempName);
        } else if (value instanceof String) {
            _callback.gotString(tempName, (String) value);
        } else if (value instanceof Boolean) {
            _callback.gotBoolean(tempName, (Boolean) value);
        } else if (value instanceof Integer) {
            _callback.gotInt(tempName, (Integer) value);
        } else if (value instanceof Long) {
            _callback.gotLong(tempName, (Long) value);
        } else if (value instanceof Double) {
            _callback.gotDouble(tempName, (Double) value);
        }
    }
