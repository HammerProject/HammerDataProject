...
import org.hammer.colombo.splitter.DataSetSplitter;
...
/**
 * 
 * Colombo Input Format
 * 
 * @author mauro.pelucchi@gmail.com
 * @project Hammer-Project - Colombo
 *
 */
public class ColomboInputFormat extends InputFormat<Object, BSONObject> {

    private static final Log LOG = LogFactory.getLog(ColomboInputFormat.class);
    ...
    public List<InputSplit> getSplits(final JobContext context) throws IOException {
        ...
        try {
            MongoSplitter splitterImpl = new DataSetSplitter(context.getConfiguration());
