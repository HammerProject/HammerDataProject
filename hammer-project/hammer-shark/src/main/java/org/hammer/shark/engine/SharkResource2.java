 ...
 *
 */
public class SharkResource2 {

	public SharkResource2(SparkSession spark) {

	}

	public static final Log LOG = LogFactory.getLog(SharkResource2.class);
	...
	public static List<Tuple2<String, String>> mapper(Row ds) {
		...
		String sValue = g
				.toJson(ds.getValuesMap(JavaConverters.asScalaIteratorConverter(a.iterator()).asScala().toSeq()));
