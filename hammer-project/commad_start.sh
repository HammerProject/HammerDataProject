...
bin/yarn jar share/test/hammer-colombo-0.0.2.jar org.hammer.colombo.App share/test/8_fuzzy.json local search keywords 0.25 0.25 0.80 3 subset subindex 0.9995
