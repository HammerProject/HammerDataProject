 ...
 *
 */
public class PintaRecordWriter extends RecordWriter<Text, BSONWritable> {

	private static final Log LOG = LogFactory.getLog(PintaRecordWriter.class);
     ...
     */
    public PintaRecordWriter(final DBCollection c, final TaskAttemptContext ctx) {
        collection = c;
        context = ctx;
